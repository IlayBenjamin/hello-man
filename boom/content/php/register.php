<?php
   $myfile = fopen('data/dataB.txt', "w") or die("Unable to open file!");
   ...
   $myfile = fopen('data/dataC.txt', "w") or die("Unable to open file!");
   fwrite($myfile, $number);
   fclose($myfile);

   $command = escapeshellcmd('content/python/main.py');
